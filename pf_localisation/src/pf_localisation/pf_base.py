...
class PFLocaliserBase(object):
    ...
    def __init__(self):
        ...
        self.estimatedpose.pose.pose.orientation = \
            rotateQuaternion(Quaternion(w=1.0), self.INIT_HEADING)
    ...
    def update_filter(self, scan):
        """ Called to update the particle filter.
    ...
    def update_particle_cloud(self, scan):
        """ Update the particle filter particle cloud.
    ...
    def recalculate_transform(self, currentTime):
        ...
        transform.translation.x = -self.estimatedpose.pose.pose.position.x
        transform.translation.y = -self.estimatedpose.pose.pose.position.y
        transform.translation.z = -self.estimatedpose.pose.pose.position.z
        ...
        new_tfstamped.child_frame_id = "/map"
    ...
    def predict_from_odometry(self, odom):
        """ Include odometry information in particle cloud.
