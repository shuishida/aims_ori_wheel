...
class SafetyController(object):
    ...
    def __init__(self):
        ...
        self.vel_pub = rospy.Publisher('joy_teleop/cmd_vel', Twist, queue_size=10)
        rospy.Subscriber('/bluetooth_teleop/joy', Joy, self.store_joystick)
        rospy.Subscriber('/obstacle_detected', Bool, self.override_control)
        self.x_button = 0
        rospy.spin()
